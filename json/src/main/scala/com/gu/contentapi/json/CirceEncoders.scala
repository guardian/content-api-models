...
object CirceEncoders {
  ...
  implicit val mediaSelfHostedDataEncoder: Encoder[media.SelfHostedData] = deriveEncoder
  implicit val mediaVideoPlayerFormatEncoder: Encoder[media.VideoPlayerFormat] = deriveEncoder
