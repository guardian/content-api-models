...
object ContentTypeSerializer extends CustomSerializer[ContentType](format => (
  {
    case JString(s) => ContentType.valueOf(norm(s)).getOrElse(ContentType.EnumUnknownContentType(-1))
  },
...
object MembershipTierSerializer extends CustomSerializer[MembershipTier](format => (
  {
    case JString(s) => MembershipTier.valueOf(norm(s)).getOrElse(MembershipTier.EnumUnknownMembershipTier(-1))
  },
...
object OfficeSerializer extends CustomSerializer[Office](format => (
  {
    case JString(s) => Office.valueOf(norm(s)).getOrElse(Office.EnumUnknownOffice(-1))
  },
  generateJson[Office]
  ))
...
object AssetTypeSerializer extends CustomSerializer[AssetType](format => (
  {
    case JString(s) => AssetType.valueOf(norm(s)).getOrElse(AssetType.EnumUnknownAssetType(-1))
  },
...
object ElementTypeSerializer extends CustomSerializer[ElementType](format => (
  {
    case JString(s) => ElementType.valueOf(norm(s)).getOrElse(ElementType.EnumUnknownElementType(-1))
  },
...
object SponsorshipTypeSerializer extends CustomSerializer[SponsorshipType](format => (
  {
    case JString(s) => SponsorshipType.valueOf(norm(s)).getOrElse(SponsorshipType.EnumUnknownSponsorshipType(-1))
  },
...
object TagTypeSerializer extends CustomSerializer[TagType](format => (
  {
    case JString(s) => TagType.valueOf(norm(s)).getOrElse(TagType.EnumUnknownTagType(-1))
  },
...
object CrosswordTypeSerializer extends CustomSerializer[CrosswordType](format => (
  {
    case JString(s) => CrosswordType.valueOf(norm(s)).getOrElse(CrosswordType.EnumUnknownCrosswordType(-1))
  },
...
object StoryPackageArticleTypeSerializer extends CustomSerializer[ArticleType](format => (
  {
    case JString(s) => ArticleType.valueOf(norm(s)).getOrElse(ArticleType.EnumUnknownArticleType(-1))
  },
...
object StoryPackageGroupSerializer extends CustomSerializer[Group](format => (
  {
    case JString(s) => Group.valueOf(norm(s)).getOrElse(Group.EnumUnknownGroup(-1))
  },
  generateJson[Group]
  ))
