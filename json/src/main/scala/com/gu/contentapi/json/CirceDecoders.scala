...
object CirceDecoders {
  ...
  implicit val mediaSelfHostedDataDecoder: Decoder[media.SelfHostedData] = deriveEncoder
  implicit val mediaVideoPlayerFormatDecoder: Decoder[media.VideoPlayerFormat] = deriveEncoder
